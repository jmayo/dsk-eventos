Personal.Views.EventoCatalogos = Backbone.View.extend({
  
  template: Handlebars.compile($("#eventos-catalogos-template").html()),
  ...
  addOne: function (catalogo) {
    ...
    var catalogoView = new Personal.Views.EventoCatalogo({ model: catalogo , seleccionado:this.options.cdu_seleccionado }); 
